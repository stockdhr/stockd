/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=backend/wrangler.jsonc` (hash: 61341077d1025a093d86b4deebb51586)
// Runtime types generated with workerd@1.20260903.1 2026-09-06 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ENVIRONMENT: "production";
	ALLOWED_ORIGIN: "https://stockdhr.github.io";
	SETUP_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGIN" | "SETUP_SECRET">> {}
}
